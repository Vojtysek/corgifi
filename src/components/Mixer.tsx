  ...
  return (
    <Drag name="Mixer" closable={true}>
      <main className="flex flex-col items-center justify-center w-[311px] h-[381px] flex-1 border overflow-y-scroll rounded-xl gap-3 p-1.5">
        ...
        <div className="flex flex-col items-center justify-center w-11/12 h-1/6 flex-1 border-2 border-black rounded"></div>
        <div className="flex flex-col items-center justify-center w-11/12 h-3/6 flex-1 border-2 border-black rounded"></div>
      </main>
    </Drag>
  );
};
